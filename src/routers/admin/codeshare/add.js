...
console.log("[mebot.ga]: Admin/CodeShare/Add router loaded.");
...
app.post("/admin/addcode", global.checkAuth, async (req, res) => {
    ...
    client.channels.cache.get(global.config.server.channels.codelog).send(new Discord.MessageEmbed()
        ...
        .setDescription(`The user named **[${req.user.username}](https://mebot.ga/user/${req.user.id})** added the code named **${rBody['codename']}** to the system.`)
